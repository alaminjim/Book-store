        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 md:space-y-8">
            ...
            <h1 className="font-display text-5xl sm:text-6xl md:text-7xl leading-[1.05] tracking-tight uppercase">
              Books with <br />
              <span className="italic font-normal text-volt font-serif normal-case">substance</span> & <br />
              exquisite design.
            </h1>
            
            <p className="text-ink/75 max-w-xl text-base md:text-lg font-light leading-relaxed">
              We believe physical books are art. Our curated selection highlights exceptional minds, archival binding materials, and independent publishers worldwide.
            </p>
